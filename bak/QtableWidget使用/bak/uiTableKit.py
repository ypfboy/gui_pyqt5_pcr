...
class Table(object):
    ...
    def create_row(self):
        newItem = QtWidgets.QTableWidgetItem("A")
        self.tableWidget.setItem(0, 0, newItem)
        newItem = QtWidgets.QTableWidgetItem("阴性")
        self.tableWidget.setItem(0, 1, newItem)
        newItem = QtWidgets.QTableWidgetItem("40")
        self.tableWidget.setItem(0, 2, newItem)
        newItem = QtWidgets.QTableWidgetItem("40")
        self.tableWidget.setItem(0, 3, newItem)
        newItem = QtWidgets.QTableWidgetItem("38")
        self.tableWidget.setItem(0, 4, newItem)
        newItem = QtWidgets.QTableWidgetItem("36")
        ...
        self.tableWidget.setCellWidget(0, 6, self.frame1)
        # 设置某一列不可编辑
...
if __name__ == "__main__":
    ...
    # 行数加一
    win.tableWidget.setRowCount(win.tableWidget.rowCount()+1)
    # 写入数据
    win.create_row()
    main_window.show()
    sys.exit(app.exec_())
